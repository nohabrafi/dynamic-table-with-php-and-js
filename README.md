This project is about dynamically refreshing the data that is displayed in a table. Initally when the page is loaded the first PHP section gets the data from
